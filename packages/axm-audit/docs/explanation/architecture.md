...
- **CLI** — `axm audit . --json-output`, generated from the `AuditTool` entry point under `axm.tools`
...
sequenceDiagram
    ...
    User->>CLI: axm audit . --json-output / audit_project(Path("."))
