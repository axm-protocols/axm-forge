...
def test_standalone_pyproject_pins_prek() -> None:
    """AC1: python-project dev deps pin prek>=0.4,<0.5, not pre-commit."""
...
def test_workspace_pyproject_pins_prek() -> None:
    """AC2: uv-workspace dev deps pin prek>=0.4,<0.5, not pre-commit."""
...
def test_member_pyproject_pins_prek() -> None:
    """AC3: workspace-member dev deps pin prek>=0.4,<0.5 (only surface)."""
