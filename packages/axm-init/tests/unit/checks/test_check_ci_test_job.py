...
class TestCheckCiTestJob:
    ...
    def test_passed(
        ...
        r = check_ci_test_job(project)
        assert r.passed is expected

    def test_ci_test_job_requires_real_matrix(self, tmp_path: Path) -> None:
    ...
    def test_ci_test_job_passes_with_matrix(self, tmp_path: Path) -> None:
