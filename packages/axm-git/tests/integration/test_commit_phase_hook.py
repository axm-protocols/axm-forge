"""Integration tests for CommitPhaseHook.
...
Merged from ``test_commit_phase.py`` — CommitPhaseHook-only scenarios
(legacy mode, from_outputs, workspace, file diagnostics).
"""
