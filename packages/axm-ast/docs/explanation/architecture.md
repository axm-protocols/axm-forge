...
| `dead_code.py` | Dead code detection with test/lazy-import/base-class/intra-module-ref scanning; respects `.gitignore` via `_discover_py_files` | `find_dead_code()`, `DeadSymbol` |
